...
* This may seem drastic, but it's very convenient. If your program needs to read that file and can't do anything if the file doesn't exist, existing is valid strategy. There's even a shortcut method on `Result`s, called `unwrap`:
